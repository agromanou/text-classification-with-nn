...
class StackedCNN(ModelNN):
    ...
    def build_model(self, word_index, embedding_matrix):
        ...
        l_cov1 = layers.Conv1D(128, 5, activation=self.deep_activation)(embedded_sequences)
        ...
        l_cov3 = layers.Conv1D(128, 5, activation='relu')(l_pool2)
        l_pool3 = layers.MaxPooling1D(35)(l_cov3)  # global max pooling
...
def run_parameter_tuning(max_sequence_length,
    ...
    average = dict()
    histories = dict()
    with open('results_stacked_cnn.txt', 'a') as f:
        for i in comb:
            mlp = StackedCNN(max_sequence_length=i[0],
                             embedding_dim=i[1],
                             loss=i[3],
                             optimizer=i[2],
                             deep_activation=i[4],
...
def best_mpl_model(max_sequence_length,
    ...
    cnn_best = StackedCNN(max_sequence_length=1000,
                          embedding_dim=100,
                          loss='categorical_crossentropy',
                          optimizer='sgd',
