...
from app import NEGATIVE_WORDS, POSITIVE_WORDS, CONTRACTION_MAP
from app.text_mining import tokenize_text
...
class WordLengthMetricsExtractor(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X, y=None):
        ...
        if X is None:
            ...
            print('Calculating {} for "{}" Column'.format(self.metric, self.col_name))
...
class TextLengthExtractor(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X, y=None):
        if X is None:
            print('Calculating text length for "{}" Column'.format(self.col_name))
            out = X.apply(len)
...
class ContainsSpecialCharactersExtractor(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X, y=None):
        ...
        print('Checking whether text contains special characters for "{}" Column'.format(self.col_name))
...
class ContainsUppercaseWords(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X, y=None):
        ...
        if self.col_name is None:
            print('Checking if text contains uppercase words for pandas series')
            out = X.apply(self.calculate_uppercase_words_in_tokens)

        else:
            print('Checking if text contains uppercase words for "{}" Column'.format(self.col_name))
...
class NumberOfTokensCalculator(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X, y=None):
        print('Counting number of tokens for "{}" Column'.format(self.col_name))
...
class HasSentimentWordsExtractor(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X, y=None):
        ...
        print('Searching for {} sentiment of tokens for "{}" Column'.format(self.sentiment, self.col_name))
...
class SentenceEmbeddingExtractor(BaseEstimator, TransformerMixin):
    ...
    def calculate_updated_sentence_embeddings(self, X):
        ...
        if self.word_embeddings_dict is None:
            print('Loading word embeddings for {} dimensions'.format(self.embedding_dimensions))
            word_embeddings = GloveWordEmbedding.get_word_embeddings(dimension=self.embedding_dimensions)
        else:
            print('Loading pre loaded word embeddings for {} dimensions'.format(self.embedding_dimensions))
    ...
    def transform(self, X, y=None):
        ...
        if self.col_name is None:
            print('Calculating word embeddings of sentences for pandas series')
...
class ContractionsExpander(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X, y=None):
        if self.col_name is None:
            print('Extracting contractions for pandas series')
            return X.apply(self.expand_contractions)

        print('Extracting contractions for "{}" Column'.format(self.col_name))
...
class LemmaExtractor(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X, y=None):
        if self.col_name is None:
            print('Extracted Lemmatized words for text for pandas series')
            return X.apply(self.lemmatize_text)

        print('Extracted Lemmatized words for text for "{}" Column'.format(self.col_name))
